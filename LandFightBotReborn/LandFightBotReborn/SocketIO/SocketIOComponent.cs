...
{
    /// <summary>
    /// By M.Fakhreddin simple IO component
    /// </summary>
    public class SocketIOComponent
    {
        ...
        public SocketIOComponent(string url,int reconnectDelay,float ackExpirationTime,float pingInterval,float pingTimeout)
        {
            this.reconnectDelay = reconnectDelay;
            this.ackExpirationTime = ackExpirationTime;
        ...
        public void initialize(string url)
        {
            ...
            Start();
            isAlive = true;
            Thread updateThread = new Thread(updateCaller);
            updateThread.Start();
        }
