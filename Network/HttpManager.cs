...
namespace LandFightBotReborn.Network
{
        ...
        public class HttpManager
        {
            ...
            public JsonData getRequest(string uri, String[] headerKeys, String[] headerValues)
            {
            ...
            /// <returns></returns>
            public JsonData PostRequset(string uri, NameValueCollection pairs, String[] headerKeys, String[] headerValues)
            {
                byte[] response = null;
            ...
            public string getSession(Dictionary<string, string> headers)
            {
